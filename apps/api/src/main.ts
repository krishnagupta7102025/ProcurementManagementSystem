...
// Vercel's zero-config NestJS support (docs/deploy-vercel.md) wraps this
// file as a single Vercel Function automatically — it does this via static
// detection that specifically looks for NestFactory.create(AppModule)
// called directly in src/main.ts, so this bootstrap must stay inline here
// rather than delegated to a helper module (an earlier version of this
// file did exactly that and broke deployment with "No entrypoint found
// which imports nestjs").
