        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {selectedRequisition && (
            <Card className="space-y-3">
              <h2 className="text-sm font-semibold text-stone-700 dark:text-stone-300">Lines to order</h2>
              {lines.map((line, index) => (
                <div key={line.requisitionLineId} className="grid items-end gap-3 rounded-lg border border-stone-200 p-3 sm:grid-cols-12 dark:border-stone-800">
