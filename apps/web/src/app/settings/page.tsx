...
import { BuildingIcon, ClipboardIcon } from '../../components/icons';
...
export default function SettingsPage() {
  ...
  if (user.role !== 'ADMIN') {
    return (
      <div>
        ...
        <EmptyState>Settings are only available to Admin users. Switch to Ada Admin to manage departments and users.</EmptyState>
      </div>
    );
  }
  ...
  return (
    <div>
      <PageHeader title="Settings" subtitle="Configure departments and provision users for your organization." />
